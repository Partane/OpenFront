...
import { AdminGiveGoldExecution, AdminGiveTroopsExecution, AdminSetMultipliersExecution } from "./AdminGiveExecution";
  ...
  createExec(intent: Intent): Execution {
    ...
    switch (intent.type) {
      ...
      case "admin_give_gold":
        return new AdminGiveGoldExecution(player, intent.recipient, intent.gold);
      case "admin_give_troops":
        return new AdminGiveTroopsExecution(player, intent.recipient, intent.troops);
      case "admin_set_multipliers":
        return new AdminSetMultipliersExecution(
          player,
          intent.recipient,
          (intent as any).goldMultiplier ?? null,
          (intent as any).troopMultiplier ?? null,
        );
      case "embargo":
